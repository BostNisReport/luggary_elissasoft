...
<body id="page-top" class="index">
    ...
    <!-- Header -->
    <header style="color: #060606;background-color: #FFFFFF;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 page-scroll">
                   <a href="#donation">  <img class="img-responsive" src="img/success.png" alt=""></a>
                    <div class="intro-text">
                        <span class="name">Payment Successful</span>
                        <hr class="star-primary">
                        <span class="skills">We are very thankful for your donation</span>
                    </div>
                </div>
            </div>
        </div>
